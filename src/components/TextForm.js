    ...
    <>
      <div className='container'>
        <div className="mb-3">
          ...
          <button className="btn btn-primary mx-1 my-2" onClick={handleOnUpClick}>Convert to Upper</button>
          <button className="btn btn-primary mx-1 my-2" onClick={handleOnLoClick}>Convert to Lower</button>
          <button className="btn btn-info mx-1 my-2"  onClick={handleOnExClick}>Solves Expression</button>
        </div>
        <div className="container">
